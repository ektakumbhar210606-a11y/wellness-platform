 ...
 */
export function formatBookingId(internalId: string): string {
 ...
 */
export function getInternalBookingId(displayId: string): string | null {
 ...
 */
export function clearBookingIdCache(): void {
 ...
 */
export function initializeBookingIds(bookingIds: string[]): void {
 ...
 */
export function getAllBookingIdMappings(): Map<string, string> {
